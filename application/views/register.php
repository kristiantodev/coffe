...
<html lang="en">
    ...
    <form class="form-horizontal m-t-30" action="<?php base_url('login/register') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nm_user" required class="form-control" id="username" placeholder="Enter Nama User">
                            </div>

                            <div class="form-group row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-primary w-md waves-effect waves-light col-12" type="submit">Daftar</button>
                                </div>
                            </div>
                        </form>
                                </div>
